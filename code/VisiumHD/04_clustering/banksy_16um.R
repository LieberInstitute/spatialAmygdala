...
# colnames(605189): s_0016um_00301_00321-1 s_0016um_00602_00290-1 ...
#   s_0016um_00353_00477-1 s_0016um_00595_00611-1
...
saveRDS(spe.hvg, here("processed-data", "VisiumHD","04_clustering", "banksy_16um","AmyHD_016_pilot_banksy_hvg.rds"))

# add cluster names back to original SPE
spe$cluster <- spe.hvg$clust_M0_lam0.8_k50_res0.8

saveRDS(spe, here("processed-data", "VisiumHD","04_clustering", "banksy_16um","AmyHD_016_pilot_banksy.rds"))
