...
hd_dir <-  here("processed-data", "VisiumHD", "01_spaceranger", "H1-W369TJK_A1", "outs", "binned_outputs")
...
# save
saveRDS(spe.008, file=here("processed-data", "VisiumHD", "02_build_spe", "AmyHD_008_pilot.rds"))
saveRDS(spe.016, file=here("processed-data", "VisiumHD", "02_build_spe","AmyHD_016_pilot.rds"))
saveRDS(spe.002, file=here("processed-data", "VisiumHD", "02_build_spe", "AmyHD_002_pilot.rds"))