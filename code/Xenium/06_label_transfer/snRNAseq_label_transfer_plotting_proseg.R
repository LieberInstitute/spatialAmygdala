...
png(file=here(plot_dir, "SpotPlots_fine_labels_ITCs.png"), width=15, height=15, units="in", res=300)
...
png(file=here(plot_dir, "SpotPlots_fine_labels_inhibitory.png"), width=15, height=15, units="in", res=300)
