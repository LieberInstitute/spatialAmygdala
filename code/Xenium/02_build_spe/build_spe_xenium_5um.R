...
spe.1 <- readXeniumSXE(here("processed-data","Xenium", "01_resegment", "5um_segmentations", xenium_names[1], "outs"))
spe.1 
spe.1$brnum <- "Br9206"
...
spe.2 <- readXeniumSXE(here("processed-data","Xenium", "01_resegment",  "5um_segmentations",xenium_names[2], "outs"))
spe.2
spe.2$brnum <- "Br9017"
...
spe.3 <- readXeniumSXE(here("processed-data","Xenium", "01_resegment", "5um_segmentations", xenium_names[3], "outs"))
spe.3
spe.3$brnum <- "Br9192"
...
spe.4 <- readXeniumSXE(here("processed-data","Xenium", "01_resegment", "5um_segmentations", xenium_names[4], "outs"))
spe.4
spe.4$brnum <- "Br9280"
...
# save
save(spe, file = here("processed-data","Xenium", "02_build_spe", "spe_xenium_5um.Rdata"))