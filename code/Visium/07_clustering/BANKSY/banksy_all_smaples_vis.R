...
pdf(file = here::here("plots", "Visium", "07_clustering", "BANKSY", "banksy_all_samples.pdf"), width = 10, height = 10)
...
pdf(file.path(plot_dir, "ggspavis_Test.pdf"), width = 8, height = 12)
ggspavis::plotVisium(spe, annotate="GULP1")
dev.off()
