...
png(file = here("plots", "Visium", "07_clustering", "BANKSY", "Br8325_Banksy_lambda_0.4_susbset_multisample_k18_res0.4.png"), width=10, height=10, units="in", res=300)
...
saveRDS(spe.subset, here("processed-data", "Visium","07_clustering", "BANKSY", "Br8325_Banksy_lambda_0.8_stitched.rds"))
