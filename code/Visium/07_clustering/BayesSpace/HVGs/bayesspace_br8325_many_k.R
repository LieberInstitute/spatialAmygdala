...
cluster_export(
    spe,
    bayesSpace_name,
    cluster_dir = here::here("processed-data","Visium", "07_clustering", "BayesSpace","HVGs","Br8325")
)
...
pdf(file = here::here("plots","Visium", "07_clustering", "BayesSpace", "HVGs", "Br8325", paste0(bayesSpace_name, ".pdf")), width = 10, height = 10)
