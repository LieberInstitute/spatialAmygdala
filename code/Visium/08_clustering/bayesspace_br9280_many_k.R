...
Sys.time()
set.seed(2)
spe <- spatialCluster(spe, use.dimred = "PCA", q = k, nrep=10000, burn.in=100, gamma=3)
Sys.time()
...
cluster_export(
    spe,
    bayesSpace_name,
    cluster_dir = here::here("processed-data","Visium", "08_clustering", "BayesSpace","HVGs","cluster_csv","Br8325")
)
...
pdf(file = here::here("plots","Visium", "08_clustering", "BayesSpace", "Br8325", paste0(bayesSpace_name, ".pdf")), width = 10, height = 10)
