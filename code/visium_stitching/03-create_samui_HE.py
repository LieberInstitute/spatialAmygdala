...
samui_dir = Path(here('processed-data', 'visium_stitching', this_donor))
samui_dir.mkdir(parents = True, exist_ok = True)

sample_info_path = Path(here('processed-data', 'visium_stitching', 'transformationsHE.csv'))
...
spe_path = here("processed-data", "visium_stitching", "spe.h5ad")
...
img_fullres = Path(here("processed-data", "visium_stitching",  "combined_"+this_donor, "combined_"+this_donor+"_lowres.tif"))
